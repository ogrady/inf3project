...
public class SHA1 {
	 ...
	 * @throws NoSuchAlgorithmException if the underlying system does not support SHA1
	 * @throws UnsupportedEncodingException if the underlying system does not support UTF-8
	 */
